#!/bin/bash
#
# Run scGPT across all datasets and splits
# Usage: bash run_scgpt_all.sh
#
...
echo "========================================================================"
echo "Running scGPT across all datasets and splits"
echo "========================================================================"
...
for dataset in "${DATASETS[@]}"; do
    for split in "${SPLITS[@]}"; do
        ...
        echo ""
        echo "========================================================================"
        echo "[$CURRENT/$TOTAL] Running scGPT on ${dataset}, split ${split}"
        echo "========================================================================"
