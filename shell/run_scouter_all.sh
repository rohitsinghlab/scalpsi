#!/bin/bash
#
# Run scouter across all datasets and splits
# Usage: bash run_scouter_all.sh
#

# DATASETS=("hepg2" "rpe1" "jurkat" "HCT116" "HEK293T" "K562" )

DATASETS=("HCT116" "HEK293T" "K562" )
SPLITS=(0 1 2 3 4)
HVG=5000
SUFFIX=""
METHOD="scouter"
...
echo "========================================================================"
echo "Running scouter across all datasets and splits"
echo "========================================================================"
...
for dataset in "${DATASETS[@]}"; do
    for split in "${SPLITS[@]}"; do
        ...
        echo ""
        echo "========================================================================"
        echo "[$CURRENT/$TOTAL] Running scouter on ${dataset}, split ${split}"
        echo "========================================================================"
