#!/bin/bash
#
# Run GenePert across all datasets and splits
# Usage: bash run_genepert_all.sh
#
...
echo "========================================================================"
echo "Running GenePert across all datasets and splits"
echo "========================================================================"
...
for dataset in "${DATASETS[@]}"; do
    for split in "${SPLITS[@]}"; do
        ...
        echo ""
        echo "========================================================================"
        echo "[$CURRENT/$TOTAL] Running GenePert on ${dataset}, split ${split}"
        echo "========================================================================"
